...
import { generateCareerGuidance } from '../services/gemini';

interface CareerPathProps {
  initialMode?: 'TEEN' | 'KIDS';
}
...
const CareerPath: React.FC<CareerPathProps> = ({ initialMode = 'TEEN' }) => {
  const [mode, setMode] = useState<'TEEN' | 'KIDS'>(initialMode);
