  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      for await (const chunk of stream) {
        ...
        // Grounding chunks are not currently supported in the OpenAI service bridge.
      ...
      // Auto-speak if it's not too long and user might expect it (optional, maybe just button for now)
      // speakText(fullText); 
