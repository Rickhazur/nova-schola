...
import { generateParentEmailReport } from '../services/gemini';
import { 
  updateGlobalConfig, 
  registerStudent, 
  fetchGlobalConfig, 
                                                  ...
                                                  <div className="flex flex-col items-end gap-2">
                                                      {report.homework_score !== null && report.homework_score !== undefined && (
                                                          <div className={`px-3 py-1 rounded-full text-sm font-bold ${
                                                              report.homework_score >= 90 ? 'bg-emerald-100 text-emerald-700' : 'bg-amber-100 text-amber-700'
                                                          }`}>
                    ...
                    <div className="text-right shrink-0">
                      {session.homework_score !== null && session.homework_score !== undefined ? (
                        <div className={`inline-block px-3 py-1 rounded-full text-sm font-bold ${
                          session.homework_score >= 90 ? 'bg-emerald-100 text-emerald-700' : 'bg-amber-100 text-amber-700'
                        }`}>
